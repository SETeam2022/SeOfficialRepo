...
/**
 * An object of this class represent the action of changeing the fill color of 
 * a shape, the onject also stores all the information neded for the undo of its
 * operation
 */
