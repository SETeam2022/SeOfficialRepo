...
public class PolygonEditor extends ShapeEditor<Polyline> {
     ...
     * coordinate of a shape, normalizes all the other points, rescaling them in
     * the new range.
     *
     * @param polygon
     * @param width
    ...
    /**
     * This method is used to set the height of a polygon to a given
     * number.Starting from the new desired height, calculates the minimum and
     * maximum y coordinate of a shape, normalizes all the other points,
     * rescaling them in the new range.
     *
     * @param polygon
     * @param height
     */
    ...
    /**
     * This method is used to get the height of a polygon.It is calculated as
     * the difference between the minimum and maximum y values of the polygon.
     *
     * @param polygon
    ...
    /**
     * This method is used to get the minimum coordinate of a polygon. All the x
     * or y coordinates (according to the specified parameter, 0 for the x and 1
     * for the y) are compared in order to get the minimum one.
     *
     * @param points
     * @param start
    ...
    /**
     * This method is used to get the maximum coordinate of a shape. All the x
     * or y coordinates (according to the specified parameter, 0 for the x and 1
     * for the y) are compared in order to get the maximum one.
     *
     * @param points
     * @param start
